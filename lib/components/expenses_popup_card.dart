...
class ExpensesPopupCard extends StatefulWidget {
  @override
  _ExpensesPopupCardState createState() => _ExpensesPopupCardState();
}

class _ExpensesPopupCardState extends State<ExpensesPopupCard> {
